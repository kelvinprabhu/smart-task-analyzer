...
from .views import AnalyzeTasksView, SuggestTasksView, ResetTasksView, ListTasksView, EisenhowerView, GraphView, DeleteTasksView
...
urlpatterns = [
    ...
    path("delete/", DeleteTasksView.as_view()),
